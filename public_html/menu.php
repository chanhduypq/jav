<nav class="navbar navbar-default" style="margin-bottom: 5px;">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            <li<?php if (strpos($_SERVER['SCRIPT_NAME'], 'index') !== FALSE&&strpos($_SERVER['SCRIPT_NAME'], 'torrent') === FALSE&&strpos($_SERVER['SCRIPT_NAME'], 'google') === FALSE&&strpos($_SERVER['SCRIPT_NAME'], 'sites') === FALSE) echo ' class="active"'; ?>><a href="/index.php">Database Search</a></li>
            ...
            <li<?php if (strpos($_SERVER['SCRIPT_NAME'], 'torrent') !== FALSE) echo ' class="active"'; ?>><a href="/torrent/public/">Torrent Search</a></li>
            <li<?php if (strpos($_SERVER['SCRIPT_NAME'], 'google') !== FALSE) echo ' class="active"'; ?>><a href="/google/public/">Engine Search</a></li>
        </ul>
    </div>
</nav>